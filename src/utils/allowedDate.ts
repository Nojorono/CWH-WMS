...
/**
 * Panggil fungsi ini saat aplikasi pertama kali dimuat (di App.tsx / main.tsx)
 */
...
export const getTargetDate = (roleName: string | undefined): string => {
  ...
  const daysToAdd =
    roleName === "WH_ADMIN_CABANG" || roleName === "FAS" ? 1 : 2;
...
// ============================================================================
export const isGenerateDOAllowed = (callPlanStartDate?: string): boolean => {
...
export const getGenerateErrorMessage = (callPlanStartDate: string): string => {
  const hMinus2 = dayjs(callPlanStartDate)
    .subtract(2, "day")
    .format("DD MMM YYYY");
  const hMinus1 = dayjs(callPlanStartDate)
    .subtract(1, "day")
    .format("DD MMM YYYY");
...
const isHMinusOne = (callPlanStartDate: string | undefined): boolean => {
  ...
  const batasWaktu = dayjs(callPlanStartDate)
    .subtract(1, "day")
    .format("YYYY-MM-DD");
...
// ============================================================================
export const isCalculationTimeAllowed = (
  callPlanStartDate: string | undefined,
): boolean => {
...
// ============================================================================
export const isGetBTBTimeAllowed = (
  callPlanStartDate: string | undefined,
): boolean => {
  if (!isHMinusOne(callPlanStartDate)) return false;
  return true;
