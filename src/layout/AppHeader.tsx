...
const AppHeader: React.FC = () => {
  ...
  return (
    <>
      <CustomToast />
      {/* PENTING: jangan pakai `grow` — itu yang bikin header height ~900px & serap klik */}
      <header className="sticky top-0 z-40 flex h-auto w-full shrink-0 self-start border-b border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900">
