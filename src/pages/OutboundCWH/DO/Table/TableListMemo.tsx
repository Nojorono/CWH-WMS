...
interface TableListMemoProps<T> {
  data: T[];
...
const TableListMemo = <T extends { [key: string]: any }>({
  data,
  columns,
  globalFilter,
  setGlobalFilter,
  ...
  useEffect(() => {
    if (!onSelectionChange || !selectionColumn) return;
