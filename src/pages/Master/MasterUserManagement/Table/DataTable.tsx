...
//                   className="flex-1 px-3 py-2 border rounded-md focus:ring-2 focus:ring-blue-400 outline-none transition-all text-sm"
//                   value={nikInput}
//                   onChange={(e) => {
...
//         hiddenWhen: (values: any) => values.userType !== "NON",
//       },
//       {
//         name: "roleId",
//         label: "Role",
