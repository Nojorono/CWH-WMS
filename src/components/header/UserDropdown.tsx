...
export default function UserDropdown() {
  ...
  const displayName = isSuperAdmin ? "Superadmin" : (storedFullName || "Guest User");
    ...
    <div className="relative inline-block text-left">
      ...
      >
        <div className="relative">
          <div className={`flex items-center justify-center w-10 h-10 rounded-full shadow-inner transition-transform group-hover:scale-105 ${
            isSuperAdmin 
      ...
      >
        ...
        <div className="px-5 py-5 bg-gray-50/50 dark:bg-white/[0.02]">
          <div className="flex items-center gap-4">
             <div className={`h-12 w-12 rounded-2xl flex items-center justify-center font-bold text-xl shadow-sm ${
               isSuperAdmin 
